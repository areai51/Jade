(function(window, document, undefined) {
  ...
  app.addEventListener('template-bound', function() {
    ...
    var infoPage = document.querySelector('product-details');

    // Setup categories
    app.category = 'all';

    // Setup routing
    var DEFAULT_ROUTE = '/apparel/all';
    ...
    var routes = {
      '/apparel/:category': contacts,
      '/apparel/:category/:id': info,
      '/add': add
    };
